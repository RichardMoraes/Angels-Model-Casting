...
const TalentDetailSheet = memo(function TalentDetailSheet({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="w-full sm:max-w-3xl overflow-y-auto bg-slate-50 p-0">
        {/* Custom Close Button */}
        <button
          onClick={onClose}
          ...
          <div className="relative z-10">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1 min-w-0">
                <SheetTitle className="text-3xl font-bold mb-2 text-white drop-shadow-2xl shadow-black/50">
                  {talent.name}
                </SheetTitle>
                <SheetDescription className="text-slate-200 text-lg mb-4">
                  {talent.age} anos • {talent.city}, {talent.state}
                </SheetDescription>
                <div className="flex items-center gap-3 mb-4">
                  <span className="px-3 py-1.5 bg-white/20 text-white text-sm font-medium rounded-full border border-white/30">
                    {(() => {
                  ...
                  <span className="px-3 py-1.5 bg-emerald-500/20 text-emerald-200 text-sm font-medium rounded-full border border-emerald-400/30">
                    Disponível
                  </span>
                </div>
              </div>
        ...
        <div className="p-4">
          <Tabs defaultValue="summary" className="space-y-4">
            <TabsList className="grid w-full grid-cols-4 bg-white shadow-sm p-1 rounded-lg">
              <TabsTrigger value="summary" className="data-[state=active]:bg-blue-500 data-[state=active]:text-white px-2 py-2 text-xs">
                Resumo
              </TabsTrigger>
              <TabsTrigger value="photos" className="data-[state=active]:bg-blue-500 data-[state=active]:text-white px-2 py-2 text-xs">
                Fotos ({talent.photos.length})
              </TabsTrigger>
              <TabsTrigger value="videos" className="data-[state=active]:bg-blue-500 data-[state=active]:text-white px-2 py-2 text-xs">
                Vídeos ({talent.videos.length})
              </TabsTrigger>
              <TabsTrigger value="skills" className="data-[state=active]:bg-blue-500 data-[state=active]:text-white px-2 py-2 text-xs">
            ...
            <TabsContent value="summary" className="space-y-4">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <span className="text-sm font-medium text-slate-800">+55 (11) 99999-9999</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <Mail className="w-5 h-5 text-slate-600" />
                    <span className="text-sm font-medium text-slate-800">{talent.name.toLowerCase().replace(' ', '.')}@email.com</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                    ...
                    <div className="text-sm font-medium text-slate-700 mt-1">Altura</div>
                  </div>
                  <div className="text-center p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                    <Weight className="w-5 h-5 text-green-600 mx-auto mb-2" />
                    <div className="text-lg font-bold text-slate-900">{talent.details.weightKg}kg</div>
                    <div className="text-sm font-medium text-slate-700 mt-1">Peso</div>
                  </div>
                  <div className="text-center p-3 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                    ...
                    <div className="text-sm font-medium text-slate-700 mt-1">Olhos</div>
                  </div>
                  <div className="text-center p-3 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                    <User className="w-5 h-5 text-orange-600 mx-auto mb-2" />
                    <div className="text-lg font-bold text-slate-900">{talent.details.hairColor}</div>
                    <div className="text-sm font-medium text-slate-700 mt-1">Cabelo</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                ...
                <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <span className="text-slate-800 font-medium">{talent.city}, {talent.state}</span>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="videos" className="space-y-4">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Vídeos de Demonstração</h3>
            ...
            <TabsContent value="skills" className="space-y-4">
              <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">Especialidades e Habilidades</h3>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
