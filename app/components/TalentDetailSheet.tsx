...
const TalentDetailSheet = memo(function TalentDetailSheet({
  ...
  return (
    <CustomSidebar isOpen={isOpen} onClose={onClose}>
      {talent && (
        <>
              ...
              <TabsContent value="skills" className="space-y-6 lg:space-y-8">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
                  ...
                  <div className="mt-3 text-sm text-gray-600">
                    <p>
                      <strong>F</strong> = Fotografia • <strong>E</strong> =
                      Eventos • <strong>O</strong> = Online • <strong>R</strong>{" "}
                      = Rádio/TV
                    </p>
                  </div>
                </div>
